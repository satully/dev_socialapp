...
$lang['imglib_gd_required'] = "この機能には、GDライブラリが必要です。";
$lang['imglib_gd_required_for_props'] = "画像プロパティを取得するには、お使いのサーバでGDライブラリがサポートされている必要があります。";
$lang['imglib_unsupported_imagecreate'] = "この形式の画像を処理するためのGDの機能が、お使いのサーバでサポートされていません。";
$lang['imglib_gif_not_supported'] = "GIF形式の画像はライセンスの関係でサポートされていないことがよくあります。かわわりに JPG または PNG 画像を使用してください。";
$lang['imglib_jpg_not_supported'] = "JPG形式の画像はサポートされていません。";
$lang['imglib_png_not_supported'] = "PNG形式の画像はサポートされていません。";
...
$lang['imglib_writing_failed_gif'] = "GIF 画像の書き込みに失敗しました。";
...
/* Location: ./system/language/japanese/imglib_lang.php */
