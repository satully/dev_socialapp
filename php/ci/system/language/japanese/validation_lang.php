...
$lang['is_numeric']			= "%s 欄には、数字以外は入力できません。";
$lang['integer']			= "%s 欄には、整数以外は入力できません。";
$lang['matches']			= "%s 欄が %s 欄と一致しません。";
$lang['is_natural']			= "%s 欄には、数字以外は入力できません。";
$lang['is_natural_no_zero']	= "%s 欄には、0より大きい数字以外は入力できません。";

/* End of file validation_lang.php */
/* Location: ./system/language/japanese/validation_lang.php */
