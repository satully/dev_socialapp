...
$lang['email_attachment_missing'] = "次のメール添付が見つかりません: %s";
...
$lang['email_send_failure_sendmail'] = "PHP Sendmailを使ってメールを送信できません。お使いのサーバでは、PHP Sendmailでメールを送信できるよう設定されていない可能性があります。";
$lang['email_send_failure_smtp'] = "PHP SMTPを使ってメールを送信できません。お使いのサーバでは、PHP SMTPでメールを送信できるよう設定されていない可能性があります。";
$lang['email_sent'] = "メッセージは次のプロトコルを使って正常に送信されました: %s";
$lang['email_no_socket'] = "Sendmailにソケットを開くことができません。設定を見直してください。";
$lang['email_no_hostname'] = "SMTP ホスト名が指定されていません。";
$lang['email_smtp_error'] = "次の SMTP エラーが発生しました: %s";
$lang['email_no_smtp_unpw'] = "エラー: SMTPのユーザ名とパスワードを指定する必要があります。";
...
/* Location: ./system/language/japanese/email_lang.php */
