...
$lang['db_must_set_database'] = 'データベース設定ファイルでデータベース名を設定する必要があります。';
$lang['db_must_use_set'] = 'レコードを更新するには、"set" メソッドを使う必要があります。';
$lang['db_must_use_where'] = '"where"または"LIKE"句が指定されていないデータベースの更新は許可されません。';
$lang['db_del_must_use_where'] = '"where"句が指定されていない削除は許可されません。';
$lang['db_field_param_missing'] = 'フィールド名を取り出すには、テーブル名をパラメータで指定する必要があります。';
...
$lang['db_table_name_required'] = 'テーブル名が必要です。';
$lang['db_column_name_required'] = 'コラム名が必要です。';
$lang['db_column_definition_required'] = 'コラムの定義が必要です。';
$lang['db_unable_to_set_charset'] = 'クライアント接続文字エンコードを設定できませんでした: %s';
$lang['db_error_heading'] = 'データベースエラーが発生しました。';

/* End of file db_lang.php */
/* Location: ./system/language/japanese/db_lang.php */
